...
func main() {
	app := &cli.App{
		...
		Commands: []*cli.Command{
			serverCommand,
			newDBCommand("db", "manage database migrations", migrate.NewMigrations(migrate.WithMigrationsDirectory("migrations"))),
		},
	}
...
func newDBCommand(name, usage string, migrations *migrate.Migrations) *cli.Command {
	return &cli.Command{
		Name:  name,
		Usage: usage,
